    ...
    case FormatType.decimal:
      switch (decimalType!) {
        case DecimalType.automatic:
          formattedValue = NumberFormat('#,##0.00', 'en_US')
              .format(value); // Format to two decimal places
          break;
        case DecimalType.periodDecimal:
          if (currency != null) {
            formattedValue = NumberFormat.currency(
                    symbol: currency, decimalDigits: 2, locale: 'en_US')
                .format(value);
          } else {
            formattedValue = NumberFormat('#,##0.00', 'en_US')
                .format(value); // Format to two decimal places
        ...
        case DecimalType.commaDecimal:
          if (currency != null) {
            formattedValue = NumberFormat.currency(
                    symbol: currency, decimalDigits: 2, locale: 'es_PA')
                .format(value);
          } else {
            formattedValue = NumberFormat('#,##0.00', 'es_PA')
                .format(value); // Format to two decimal places
          }
          break;
      }
