...
import 'update_feeds_model.dart';
export 'update_feeds_model.dart';

class UpdateFeedsWidget extends StatefulWidget {
  const UpdateFeedsWidget({super.key});

  @override
  State<UpdateFeedsWidget> createState() => _UpdateFeedsWidgetState();
}

class _UpdateFeedsWidgetState extends State<UpdateFeedsWidget> {
  late UpdateFeedsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateFeedsModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<FeedsRecord>>(
      stream: queryFeedsRecord(
        queryBuilder: (feedsRecord) => feedsRecord.where(
          'ID',
      ...
      builder: (context, snapshot) {
        ...
        List<FeedsRecord> updateFeedsFeedsRecordList = snapshot.data!;
        final updateFeedsFeedsRecord = updateFeedsFeedsRecordList.isNotEmpty
            ? updateFeedsFeedsRecordList.first
            : null;

        return Title(
            title: 'Update Feeds Price',
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'uf28d1py' /* Please fill out the form below... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'kwfppqri' /* Full Fat Soya per 50Kg Bag* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'gwyjy4xr' /* Low Fat Soya per 50Kg Bag* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                focusNode: _model.fishFocusNode,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'a2d8k07q' /* Fish Meal per 50Kg Bag* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'l6dmxgro' /* Dicalcium Phosphate per 50Kg B... */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: TextFormField(
                                                ...
                                                focusNode: _model.limeFocusNode,
                                                autofocus: true,
                                                textCapitalization:
                                                    TextCapitalization.words,
                                                obscureText: false,
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '1wz6zwzt' /* Methionine per 1Kg Pack* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                        .mineralTextController ??=
                                                    TextEditingController(
                                                  text: formatNumber(
                                                    updateFeedsFeedsRecord
                                                        ?.broilervitMineralpremix,
                                                    formatType:
                                                        FormatType.decimal,
                                                    decimalType:
                                                        DecimalType.automatic,
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'h7ba9zjp' /* BROILER VIT-MINERAL PREMIX per... */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'tus2iu8q' /* Concentrates per 50Kg Bag* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await updateFeedsFeedsRecord!.reference
                                      .update({
                                    ...createFeedsRecordData(
                                      maize: double.tryParse(
                                          _model.maizeTextController.text),
                                      fullfatsoya: double.tryParse(
                                          _model.fatSoyaTextController.text),
                                      lowfatsoya: double.tryParse(
                                          _model.lowfatSoyaTextController.text),
                                      fishmeal: double.tryParse(
                                          _model.fishTextController.text),
                                      dicalciumphosphate: double.tryParse(
                                          _model.dcpTextController.text),
                                      lime: double.tryParse(
                                          _model.limeTextController.text),
                                      salt: double.tryParse(
                                          _model.saltTextController.text),
                                      methionine: double.tryParse(
                                          _model.methionineTextController.text),
                                      broilervitMineralpremix: double.tryParse(
                                          _model.mineralTextController.text),
                                      concentrates: double.tryParse(_model
                                          .concentratesTextController.text),
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'createdAt':
