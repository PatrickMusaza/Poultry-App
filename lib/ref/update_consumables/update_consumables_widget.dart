...
import 'update_consumables_model.dart';
export 'update_consumables_model.dart';

class UpdateConsumablesWidget extends StatefulWidget {
  const UpdateConsumablesWidget({super.key});

  @override
  State<UpdateConsumablesWidget> createState() =>
      _UpdateConsumablesWidgetState();
}
...
class _UpdateConsumablesWidgetState extends State<UpdateConsumablesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UpdateConsumablesModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<ConsumablesRecord>>(
      stream: queryConsumablesRecord(
        queryBuilder: (consumablesRecord) => consumablesRecord.where(
          'ID',
      ...
      builder: (context, snapshot) {
        ...
        final updateConsumablesConsumablesRecord =
            updateConsumablesConsumablesRecordList.isNotEmpty
                ? updateConsumablesConsumablesRecordList.first
                : null;

        return Title(
            title: 'Update Consumables Price',
                        ...
                        children: [
                          Column(
                            ...
                            children: [
                              ...
                              Text(
                                FFLocalizations.of(context).getText(
                                  'l50ng6j5' /* Please fill out the form below... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: TextFormField(
                                                controller: _model
                                                        .vaccineTextController ??=
                                                    TextEditingController(
                                                  text: formatNumber(
                                                    updateConsumablesConsumablesRecord
                                                        ?.vaccines,
                                                    formatType:
                                                        FormatType.decimal,
                                                    decimalType:
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'eydzl8ab' /* Vaccines and other Medications... */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'mp35fo2d' /* Selling Cost per Chicken* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'z28ey2vk' /* Transport per Chicken* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    'if9aq8p3' /* Feeds Kgs per 50Kg Bag* */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                                              ...
                                              child: TextFormField(
                                                ...
                                                decoration: InputDecoration(
                                                  labelText: FFLocalizations.of(
                                                          context)
                                                      .getText(
                                                    '5071rldf' /* Daily Power Consumption per Ch... */,
                                                  ),
                                                  labelStyle:
                                                      FlutterFlowTheme.of(
                                                              context)
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  ...
                                  await updateConsumablesConsumablesRecord!
                                      .reference
                                      .update({
                                    ...createConsumablesRecordData(
                                      vaccines: double.tryParse(
                                          _model.vaccineTextController.text),
                                      selling: double.tryParse(
                                          _model.sellingTextController.text),
                                      transport: double.tryParse(
                                          _model.transportTextController.text),
                                      feeds: double.tryParse(
                                          _model.feedskgsTextController.text),
                                      water: double.tryParse(
                                          _model.waterTextController.text),
                                      power: double.tryParse(
                                          _model.powerTextController.text),
                                      litter: double.tryParse(
                                          _model.litterTextController.text),
                                      labour: double.tryParse(
                                          _model.labourTextController.text),
                                    ),
                                    ...mapToFirestore(
                                      {
                                        'createdAt':
